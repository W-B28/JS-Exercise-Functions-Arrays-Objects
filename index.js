 ...
 *
  ...
  TO DO: 1. Create a function that takes in 3 parameters
        2. Return an object
 ...
 * the returned value should look like `Hello, my name is Leia`.
    ...
    TO DO:
      1. create a function that takes one parameter.
        That parameter is an object containing a 'name' property.
      2. Return a string that reads 'Hello, my name is {name}'.
 ...
 * sortCarInventory returns an inventory that is sorted by car_model, ascending [A-Z].
 sort arrray by car model alphabetically from a though z
*/
function sortCarInventory(inventory) {
  return inventory.sort((a,b) => a.car_model.split('')[0] < b.car_model.split("")[0] ? -1 : 1);
}
